...
transaction(momentIDs: [UInt64], momentsPerPack: UInt64, price: UFix64) {
    ...
    execute {
        ...
        let packID = self.packsCollectionRef.createPack(tokens: <-tokens, momentsPerPack: momentsPerPack, price: price)
