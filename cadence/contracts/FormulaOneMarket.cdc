/*
    ...
    will receive the entirety of the purchase. FormulaOne will initialize sales 
    for users with the FormulaOne admin vault as the vault where cuts get 
    deposited to.
*/
...
pub contract Market {
    ...
    // emitted when a FormulaOne moment is listed for sale
    ...
    pub resource SaleCollection: SalePublic {
        ...
        pub fun listForSale(token: @FormulaOne.NFT, price: UFix64) {
        ...
        //
        // Returns: @FormulaOne.NFT: The nft that was withdrawn from the sale
        pub fun withdraw(tokenID: UInt64): @FormulaOne.NFT {
