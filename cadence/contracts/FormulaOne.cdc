/*
    Description: Central Smart Contract for F1 Grid

    This smart contract contains the core functionality for 
    F1 Grid, created by Dapper Labs
    ...
    every FormulaOne NFT owner will store in their account
    to manage their NFT collection.

    The main Formula One account will also have its own Moment collections
...
pub contract FormulaOne: NonFungibleToken {
    // -----------------------------------------------------------------------
    // FormulaOne deployment variables
    // -----------------------------------------------------------------------
    ...
    pub fun SubeditionAdminStoragePath() : StoragePath { return /storage/FormulaOneSubeditionAdmin}

    // -----------------------------------------------------------------------
    // FormulaOne contract Events
    // -----------------------------------------------------------------------

    // Emitted when the FormulaOne contract is created
    ...
    // -----------------------------------------------------------------------
    // FormulaOne contract-level fields.
    ...
    // The total number of Formula One Moment NFTs that have been created
    ...
    // -----------------------------------------------------------------------
    // FormulaOne contract-level Composite Type definitions
    // -----------------------------------------------------------------------
    ...
    pub struct Play {
        ...
        init(metadata: {String: String}) {
            ...
            self.playID = FormulaOne.nextPlayID
        ...
        access(contract) fun updateTagline(tagline: String): UInt32 {
            ...
            FormulaOne.playDatas[self.playID] = self
            return self.playID
        }
    }
    ...
    pub struct SetData {
        ...
        init(name: String) {
            ...
            self.setID = FormulaOne.nextSetID
            self.name = name
            self.series = FormulaOne.currentSeries
        }
    }
    ...
    pub resource Set {
        ...
        init(name: String) {
            ...
            FormulaOne.setDatas[self.setID] = SetData(name: name)
        }
        ...
        pub fun addPlay(playID: UInt32) {
            pre {
                FormulaOne.playDatas[playID] != nil: "Cannot add the Play to Set: Play doesn't exist."
        ...
        pub fun mintMomentWithSubedition(playID: UInt32, subeditionID: UInt32): @NFT {
            ...
            // to use as this Moment's serial number
            let subeditionRef = FormulaOne.account.borrow<&SubeditionAdmin>(from: FormulaOne.SubeditionAdminStoragePath())
    ...
    // let setData = FormulaOne.QuerySetData(setID: 12)
    //
    pub struct QuerySetData {
        ...
        init(setID: UInt32) {
            pre {
                FormulaOne.sets[setID] != nil: "The set with the provided ID does not exist"
            }

            let set = (&FormulaOne.sets[setID] as &Set?)!
            let setData = FormulaOne.setDatas[setID]!
    ...
    // This is an implementation of a custom metadata view for Formula One.
    // This view contains the play metadata.
    //
    pub struct FormulaOneMomentMetadataView {
        ...
        pub let teamAtMomentF1ID: String?
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        init(serialNumber: UInt32, playID: UInt32, setID: UInt32, subeditionID: UInt32) {
            ...
            FormulaOne.totalSupply = FormulaOne.totalSupply + UInt64(1)
        ...
        pub fun name(): String {
            let fullName: String = FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "FullName") ?? ""
            let playType: String = FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "PlayType") ?? ""
            return fullName
                .concat(" ")
                .concat(playType)
        }
        ...
        access(self) fun buildDescString(): String {
            let setName: String = FormulaOne.getSetName(setID: self.data.setID) ?? ""
            let serialNumber: String = self.data.serialNumber.toString()
            let seriesNumber: String = FormulaOne.getSetSeries(setID: self.data.setID)?.toString() ?? ""
            return "A series "
                .concat(seriesNumber)
                .concat(" ")
                .concat(setName)
        ...
        pub fun description(): String {
            let playDesc: String = FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "Tagline") ?? ""
        ...
        pub fun getViews(): [Type] {
            return [
                ...
                Type<FormulaOneMomentMetadataView>(),
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                // Custom metadata view unique to FormulaOne Moments
                case Type<FormulaOneMomentMetadataView>():
                    return FormulaOneMomentMetadataView(
                        fullName: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "FullName"),
                        firstName: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "FirstName"),
                        lastName: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "LastName"),
                        birthdate: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "Birthdate"),
                        birthplace: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "Birthplace"),
                        jerseyNumber: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "JerseyNumber"),
                        draftTeam: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "DraftTeam"),
                        draftYear: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "DraftYear"),
                        draftSelection: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "DraftSelection"),
                        draftRound: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "DraftRound"),
                        teamAtMomentF1ID: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "TeamAtMomentF1ID"),
                        teamAtMoment: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "TeamAtMoment"),
                        primaryPosition: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "PrimaryPosition"),
                        height: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "Height"),
                        weight: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "Weight"),
                        totalYearsExperience: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "TotalYearsExperience"),
                        f1Season: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "f1Season"),
                        dateOfMoment: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "DateOfMoment"),
                        playCategory: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "PlayCategory"),
                        playType: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "PlayType"),
                        homeTeamName: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "HomeTeamName"),
                        awayTeamName: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "AwayTeamName"),
                        homeTeamScore: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "HomeTeamScore"),
                        awayTeamScore: FormulaOne.getPlayMetaDataByField(playID: self.data.playID, field: "AwayTeamScore"),
                        seriesNumber: FormulaOne.getSetSeries(setID: self.data.setID),
                        setName: FormulaOne.getSetName(setID: self.data.setID),
                        serialNumber: self.data.serialNumber,
                        playID: self.data.playID,
                        setID: self.data.setID,
                        numMomentsInEdition: FormulaOne.getNumMomentsInEdition(setID: self.data.setID, playID: self.data.playID)
                    )
                case Type<MetadataViews.Editions>():
                    let name = self.getEditionName()
                    let max = FormulaOne.getNumMomentsInEdition(setID: self.data.setID, playID: self.data.playID) ?? 0
                ...
                case Type<MetadataViews.Royalties>():
                    let royaltyReceiver: Capability<&{FungibleToken.Receiver}> =
                        getAccount(FormulaOne.RoyaltyAddress()).getCapability<&AnyResource{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath())
                    return MetadataViews.Royalties(
                        royalties: [
                            MetadataViews.Royalty(
                                receiver: royaltyReceiver,
                                cut: 0.05,
                                description: "FormulaOne marketplace royalty"
                            )
                        ]
                    )
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        ...
                        providerLinkedType: Type<&FormulaOne.Collection{NonFungibleToken.Provider,FormulaOne.MomentCollectionPublic,NonFungibleToken.Receiver,NonFungibleToken.CollectionPublic,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://FormulaOne.com/static/img/f1-logo-horizontal-white.svg"
                        ),
                        mediaType: "image/svg+xml"
                    )
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://FormulaOne.com/static/img/og/og.png"
                        ),
                        mediaType: "image/png"
                    )
                    return MetadataViews.NFTCollectionDisplay(
                        name: "F1-Grid",
                        description: "F1 Grid is your chance to own, sell, and trade official digital collectibles of the F1's greatest plays and players",
                        externalURL: MetadataViews.ExternalURL("https://FormulaOne.com"),
                        squareImage: squareImage,
                        bannerImage: bannerImage,
                        socials: {
                            "twitter": MetadataViews.ExternalURL("https://twitter.com/FormulaOne"),
                            "discord": MetadataViews.ExternalURL("https://discord.com/invite/FormulaOne"),
                            "instagram": MetadataViews.ExternalURL("https://www.instagram.com/FormulaOne")
                        }
                    )
                case Type<MetadataViews.Traits>():
                    // sports radar team id
                    let excludedNames: [String] = ["TeamAtMomentF1ID"]
        ...
        pub fun mapPlayData(dict: {String: AnyStruct}) : {String: AnyStruct} {      
            let playMetadata = FormulaOne.getPlayMetaData(playID: self.data.playID) ?? {}
        ...
        pub fun getMomentURL(): String {
            return "https://FormulaOne.com/moment/".concat(self.id.toString())
        }
        ...
        pub fun assetPath(): String {
            return "https://assets.FormulaOne.com/media/".concat(self.id.toString())
        }
    ...
    pub resource Admin {
        ...
        // and stores it in the Plays dictionary in the FormulaOne smart contract
        //
        ...
        pub fun createPlay(metadata: {String: String}): UInt32 {
            ...
            FormulaOne.nextPlayID = FormulaOne.nextPlayID + UInt32(1)

            emit PlayCreated(id: newPlay.playID, metadata: metadata)

            // Store it in the contract storage
            FormulaOne.playDatas[newID] = newPlay
        ...
        pub fun updatePlayTagline(playID: UInt32, tagline: String): UInt32 {
            let tmpPlay = FormulaOne.playDatas[playID] ?? panic("playID does not exist")
            tmpPlay.updateTagline(tagline: tagline)
            return playID
        }

        // createSet creates a new Set resource and stores it
        // in the sets mapping in the FormulaOne contract
        //
        ...
        pub fun createSet(name: String): UInt32 {
            ...
            FormulaOne.nextSetID = FormulaOne.nextSetID + UInt32(1)

            let newID = newSet.setID

            emit SetCreated(setID: newSet.setID, series: FormulaOne.currentSeries)

            // Store it in the sets mapping field
            FormulaOne.sets[newID] <-! newSet

            return newID
        }

        // borrowSet returns a reference to a set in the FormulaOne
        ...
        pub fun borrowSet(setID: UInt32): &Set {
            pre {
                FormulaOne.sets[setID] != nil: "Cannot borrow Set: The Set doesn't exist"
            }
            
            // Get a reference to the Set and return it
            // use `&` to indicate the reference to the object and type
            return (&FormulaOne.sets[setID] as &Set?)!
        }
        ...
        pub fun startNewSeries(): UInt32 {
            ...
            // by incrementing the FormulaOne series number
            FormulaOne.currentSeries = FormulaOne.currentSeries + UInt32(1)

            emit NewSeriesStarted(newCurrentSeries: FormulaOne.currentSeries)
        ...
        pub fun createSubeditionAdminResource() {
            FormulaOne.account.save<@SubeditionAdmin>(<- create SubeditionAdmin(), to: FormulaOne.SubeditionAdminStoragePath())
        }
        ...
        pub fun setMomentsSubedition(nftID: UInt64, subeditionID: UInt32, setID: UInt32, playID: UInt32) {
            let subeditionAdmin = FormulaOne.account.borrow<&SubeditionAdmin>(from: FormulaOne.SubeditionAdminStoragePath())
                ?? panic("No subedition admin resource in storage")
    ...
    pub resource Collection: MomentCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            // Cast the deposited token as a FormulaOne NFT to make sure
        ...
        // not any FormulaOne specific data. Please use borrowMoment to 
        // read Moment data.
        //
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT {
    ...
    // -----------------------------------------------------------------------
    // FormulaOne contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection {
        return <-create FormulaOne.Collection()
    }

    // getAllPlays returns all the plays in FormulaOne
    //
    // Returns: An array of all the plays that have been created
    pub fun getAllPlays(): [FormulaOne.Play] {
        return FormulaOne.playDatas.values
    }
    ...
    pub fun getPlayMetaDataByField(playID: UInt32, field: String): String? {
        ...
        if let play = FormulaOne.playDatas[playID] {
    ...
    pub fun getSetName(setID: UInt32): String? {
        ...
        return FormulaOne.setDatas[setID]?.name
    }
    ...
    pub fun getSetSeries(setID: UInt32): UInt32? {
        // Don't force a revert if the setID is invalid
        return FormulaOne.setDatas[setID]?.series
    }
    ...
    pub fun getSetIDsByName(setName: String): [UInt32]? {
        ...
        for setData in FormulaOne.setDatas.values {
    ...
    pub fun getPlaysInSet(setID: UInt32): [UInt32]? {
        // Don't force a revert if the setID is invalid
        return FormulaOne.sets[setID]?.plays
    }
    ...
    pub fun isSetLocked(setID: UInt32): Bool? {
        // Don't force a revert if the setID is invalid
        return FormulaOne.sets[setID]?.locked
    }
    ...
    pub fun getMomentsSubedition(nftID: UInt64):UInt32? {
        let subeditionAdmin = self.account.borrow<&SubeditionAdmin>(from: FormulaOne.SubeditionAdminStoragePath())
            ?? panic("No subedition admin resource in storage")

        return subeditionAdmin.getMomentsSubedition(nftID: nftID)
    }

    // getAllSubeditions returns all the subeditions in FormulaOne subeditionAdmin resource
    //
    // Returns: An array of all the subeditions that have been created
    pub fun getAllSubeditions():[FormulaOne.Subedition] {
        let subeditionAdmin = self.account.borrow<&SubeditionAdmin>(from: FormulaOne.SubeditionAdminStoragePath())
            ?? panic("No subedition admin resource in storage")
    ...
    pub fun getSubeditionByID(subeditionID: UInt32):FormulaOne.Subedition {
        let subeditionAdmin = self.account.borrow<&SubeditionAdmin>(from: FormulaOne.SubeditionAdminStoragePath())
            ?? panic("No subedition admin resource in storage")
    ...
    // -----------------------------------------------------------------------
    // FormulaOne initialization function
    // -----------------------------------------------------------------------
    //
    init() {
