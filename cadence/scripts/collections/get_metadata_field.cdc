...
// for that play's metadata in the FormulaOne contract. It returns
...
pub fun main(account: Address, momentID: UInt64, fieldToSearch: String): String {
    ...
    let field = FormulaOne.getPlayMetaDataByField(playID: data.playID, field: fieldToSearch) ?? panic("Play doesn't exist")
