...
const handleFile = (e) => {
  ...
  const newItem = {...item, imgUrl: {src: URL.createObjectURL(file), width: 4000, height: 4000}}
        ...
        <Container>
          <Row>
            <Col lg="3" md="4" sm="6">
              ...
              <button className="btn btn-primary w-100 mt-3">Create Item</button>
            </Col>
              ...
              <div className="create__item">
                <form>
                  <div className="form__input">
                    ...
                    <input type="file" className="upload__input" onChange={handleFile} />
                  </div>
