...
transaction {
    ...
    prepare(acct: AuthAccount) {
        ...
        if acct.borrow<&FormulaOne.Collection>(from: /storage/MomentCollection) == nil {
            ...
            acct.link<&{NonFungibleToken.CollectionPublic, FormulaOne.MomentCollectionPublic, MetadataViews.ResolverCollection}>(/public/MomentCollection, target: /storage/MomentCollection)
        }
    }
}
`