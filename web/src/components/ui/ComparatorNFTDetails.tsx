...
const ComparatorNFTDetails = ({ tokenId, address }) => {
    ...
    const handlePurchase = async (seller, momentId, price) => {
        setLoading(true)
        const result = await _purchaseMoment(seller, momentId, price)
        if (result) {
    ...
    return (
        <>
            ...
            <div className="single__nft__content mt-4">
                ...
                <div className="nft__creator__compare d-flex gap-3 align-items-center">
...
export default ComparatorNFTDetails;
